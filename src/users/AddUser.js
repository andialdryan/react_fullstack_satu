...
export default function AddUser(){
    ...
    const{name,usrename,email} = user
        ...
        <div className="row">
            <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
                ...
                <div className="mb-3">
                    ...
                    <input type={"text"} className="form-control" placeholder="Enter your username..." name="username" value={usrename} onChange={(e)=>onInputChange(e)}/>
                </div>
                <div className="mb-3">
